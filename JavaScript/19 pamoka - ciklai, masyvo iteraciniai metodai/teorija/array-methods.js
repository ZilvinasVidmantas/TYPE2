...
console.groupCollapsed('Elementų pridėjimo ir šalinimo metodai');
{
...
console.groupCollapsed('Masyvo elementų kopijavimas ir iškirpimas');
{
  ...
  console.groupCollapsed('Array.prototype.splice - Iškirpimas');
  {
    /*
...
console.groupCollapsed('Masyvų sujungimas');
{
...
console.group('Rikiavimas');
{
  /*
    ...
    Standartiškai šis metodas, rikiuoja primityvaus tipo reikšmes, nuo mažiausios iki didžiausios
    Jeigu masyvo elementai yra kompleksiniai (Object type), tuomet reikia perduodi palyginimo funkcijos nuorodą.
