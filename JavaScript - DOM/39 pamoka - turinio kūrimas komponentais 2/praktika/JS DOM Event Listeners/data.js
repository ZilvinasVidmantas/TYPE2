const data = [
	{
		title : "Foto karuselė",
		images : [
			"https://s3-us-west-2.amazonaws.com/s.cdpn.io/t-65/cat1.jpg",
			"https://s3-us-west-2.amazonaws.com/s.cdpn.io/t-65/cat2.jpg",
			"https://s3-us-west-2.amazonaws.com/s.cdpn.io/t-65/cat3.jpg",
			"https://s3-us-west-2.amazonaws.com/s.cdpn.io/t-65/cat4.jpg"
		]
	},{
		title : "Upgraded Fizz Buzz",
		paragraph : "In this game, you enter a positive number in the form below, and I count from 0 to that number, subbing in 'Fizz' if it's divisible by 3, 'Buzz' if it's divisible by 5, and 'Fizzbuzz' if it's divisible by both",
		label : "Choose a positive number",
		button : "Submit"
	},{
		title : "Hover over me",
		paragraph : "Do not hover over me!",
		angryParagraph : "I told you not to HOVER OVER MEEEE!!!!!"
	},{
		button : ["dark", "light"],
		...
		image : "https://cdn.scratch.mit.edu/static/site/users/avatars/1000/2402.png",
		robot : {
			facingRight: true,
			speed: 100,
			top: 0,
